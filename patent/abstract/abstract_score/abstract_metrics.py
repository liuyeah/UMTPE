...
if __name__ == '__main__':
    ...
    phrase_embedding_matrix_file = 'patent/abstract/abstract_graph/abstract_graph_embedding_list.pkl'
    lower_text_file = 'example_data/example_abstract/abstract.txt'
    output_score_file = 'patent/abstract/abstract_score/abstract_influence_phrase_score.pkl'
    phrase_embedding_file = 'patent/abstract/abstract_embedding/cpc_title_abstract_phrase_embedding.pkl'
    centroid_file = 'patent/title/title_clustering/title_influence_phrase_centroids.pkl'
