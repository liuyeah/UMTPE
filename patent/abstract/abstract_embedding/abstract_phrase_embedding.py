...
def phrase_embedding(cpc_title_embedding_file, word_embedding_file, abstract_phrase_file, output_file):
    my_non_count = 0
    phrase_embedding = load_obj(cpc_title_embedding_file)
...
if __name__ == '__main__':
    ...
    phrase_embedding(cpc_title_embedding_file, word_embedding_file, abstract_phrase_file, output_file)