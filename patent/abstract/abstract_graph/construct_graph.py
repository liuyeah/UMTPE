...
if __name__ == '__main__':
    ...
    output_graph_file = 'patent/abstract/abstract_graph/abstract_graph_list.pkl'
    output_graph_embedding_file = 'patent/abstract/abstract_graph/abstract_graph_embedding_list.pkl'
