...
if __name__ == '__main__':
    original_candidate_file = 'example_data/example_abstract/abstract.txt_superspan_sequence.json'
    output_file = 'patent/abstract/abstract_candidate/abstract_candidate_synthesis.json'
