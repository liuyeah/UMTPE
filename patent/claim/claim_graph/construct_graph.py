...
if __name__ == '__main__':
    super_sapn_file = 'patent/claim/claim_candidate/claim_candidate_synthesis.json'
    phrase_embedding_file = 'patent/claim/claim_embedding/cpc_title_abstract_claim_phrase_embedding.pkl'
    output_graph_file = 'patent/claim/claim_graph/claim_graph_list.pkl'
    output_graph_embedding_file = 'patent/claim/claim_graph/claim_graph_embedding_list.pkl'
