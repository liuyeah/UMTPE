...
if __name__ == '__main__':
    original_score_file = 'patent/claim/claim_score/claim_influence_phrase_score.pkl'
    output_score_list_file = 'patent/claim/claim_score/claim_influence_phrase_list_normalized_score.pkl'
