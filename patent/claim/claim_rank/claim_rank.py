...
if __name__ == '__main__':
    ...
    graph_embedding_list_file = 'patent/claim/claim_graph/claim_graph_embedding_list.pkl'
    graph_value_list_file = 'patent/claim/claim_score/claim_influence_phrase_list_normalized_score.pkl'
    test_file = 'patent/claim/claim_rank/ranked_claim_influence_phrase_score.pkl'
