...
if __name__ == '__main__':
    ranked_phrase_file = 'patent/claim/claim_rank/ranked_claim_influence_phrase_score.pkl'
    output_file = 'patent/claim/claim_rank/ranked_claim_influence_phrase_score_text.json'
