...
if __name__ == '__main__':
    ...
    phrase_embedding_matrix_file = 'patent/title/title_graph/title_graph_embedding_list.pkl'
    lower_text_file = 'example_data/example_title/title.txt'
    output_score_file = 'patent/title/title_score/title_influence_phrase_score.pkl'
    phrase_embedding_file = 'patent/title/title_embedding/cpc_title_phrase_embedding.pkl'
    centroid_file = 'patent/cpc/cpc_clustering/cpc_centroids.pkl'
