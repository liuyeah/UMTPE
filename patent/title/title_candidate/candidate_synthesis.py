...
if __name__ == '__main__':
    original_candidate_file = 'example_data/example_title/title.txt_superspan_sequence.json'
    output_file = 'patent/title/title_candidate/title_candidate_synthesis.json'
