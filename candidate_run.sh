...
python candidate_generation/autophrase.py $RAW_TITLE
...
python candidate_generation/autophrase.py $RAW_ABSTRACT
...
python candidate_generation/autophrase.py $RAW_CLAIM
